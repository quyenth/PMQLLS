...
namespace Application.IdentityServer.Controllers.QLLS
{
    ...
    public class ChucVuController : ControllerBase
    {
        ...
        {
            var result = chucVuService.CheckNameIsUnique(id, name);
            return new ApiResult()
            {
                Status = HttpStatus.OK,
                Data = result
        ...
        {
            var result = chucVuService.CheckCodeIsUnique(id, code);
            return new ApiResult()
            {
                Status = HttpStatus.OK,
                Data = result
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<ApiResult> getListAllChucVu()
        {
            var result = chucVuService.GetListAllChucVu();
            return new ApiResult()
            {
                Status = HttpStatus.OK,
                Data = result
