...
import { DoiTuongSaveComponent } from './../doituong-save/doituong-save.component';
...
export class DoiTuongListComponent implements OnInit, OnDestroy {
  ...
  onAddNew () {
    this.modalService.openModalWithComponent(DoiTuongSaveComponent, { formType: FromType.INSERT, id: 0} , ModalSize.LARGE);
  }

  onEditItem(item) {
    this.modalService.openModalWithComponent(DoiTuongSaveComponent, { formType: FromType.UPDATE, id: item.doiTuongId} , ModalSize.LARGE);
  }
