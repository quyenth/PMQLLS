...
@Component({
  selector: 'app-ncc_PhieuCungCap-save',
  templateUrl: './ncc_phieucungcap-save.component.html'
})
export class Ncc_PhieuCungCapSaveComponent implements OnInit , OnDestroy {
  ...
  constructor(public bsModalRef: BsModalRef, private fb: FormBuilder, private modalService: ModalService ,
          private ncc_PhieuCungCapService: Ncc_PhieuCungCapService, private spinner: NgxSpinnerService,
